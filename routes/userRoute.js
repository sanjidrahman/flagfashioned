...
user_route.get('/change-passsword' , auth.isLogin , auth.isBlock , userController.loadChangePass)
...
user_route.get('/order-placed/:id' , auth.isLogin , auth.isBlock , userController.loadOrderPlaced)
user_route.get('/order-details/:id' , auth.isLogin , auth.isBlock , userController.loadOrderDetails)
user_route.get('/wishlist' , auth.isLogin , auth.isBlock , auth.isLogin , auth.isBlock , userController.loadWishlist)
user_route.get('/logout' , userController.logout)
user_route.post('/review' , userController.review)
user_route.post('/delete_review' , userController.deleteReview)
user_route.get('/invoice/:id' , userController.loadInvoice)


user_route.post('/deleteAddress' , addressController.deleteAddress)
user_route.get('/add-address' , auth.isLogin , auth.isBlock , addressController.loadAddAddress)
user_route.post('/add-address' , addressController.addAddress)
user_route.get('/edit-address' , auth.isLogin , auth.isBlock , addressController.loadEditAddress)
...
user_route.get('/add-addresss' , auth.isLogin , auth.isBlock , checkoutController.loadAddAddress)
user_route.post('/add-addresss' , checkoutController.checkoutAddAddress)
user_route.get('/check-edit-address' , auth.isLogin , auth.isBlock , checkoutController.loadEditAddAddress)
...
user_route.post('/checkout' , auth.isLogin , auth.isBlock , checkoutController.placeOrder)
